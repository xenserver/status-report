...
Special characters in commands must be XML-escaped.
In this example, the XML entity `2>&amp;1` becomes the `2>&1` to redirect `stderr`.

### Best Practises for plugin development
